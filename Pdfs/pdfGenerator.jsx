...
export const generatePDF = async (estimateData) => {
  try {
    ...
    let businessImageBase64 = "";
    if (businessInfo.businessPhoto) {
      try {
        businessImageBase64 = await FileSystem.readAsStringAsync(
        ...
        console.error("Error converting business image:", error);
      }
    }
        ...
        <body>
          ...
          <div class="address-section">
            <div class="address-block">
              ...
              ${
                businessImageBase64
                  ? `<img src="data:image/jpeg;base64,${businessImageBase64}" alt="Business Logo" class="business-logo">`
                  : ""
              }
