  ...
  return (
    <NavigationContainer>
      <Stack.Navigator screenOptions={{ headerShown: false }}>
        ...
        />
        <Stack.Screen name="Invoice Creation" component={InvoiceCreationPage} />
        ...
        />
        <Stack.Screen name="Estimate Editing" component={EstimateEditingPage} />
        <Stack.Screen name="Estimate Preview" component={EstimatePreviewPage} />
        ...
        <Stack.Screen name="ClientsSelection" component={ClientSelectionPage} />
